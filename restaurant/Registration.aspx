...
<!-- content -->
			<article id="content">
				<div class="wrap">
					<div class="box">
						<div>
							<h2 class="letter_spacing">Registraion <span>Form</span></h2>
							<form id="RegistrationForm" runat="server">
								<div>
                                    ...
                                    <div class="wrapper">
										<span>User Name:</span>
										<asp:TextBox ID="uname" runat="server" CssClass="input"></asp:TextBox>							
									</div>
                                    <div class="wrapper">
										<span>Password:</span>
										<asp:TextBox ID="pwd" runat="server" TextMode="Password" CssClass="input"></asp:TextBox>							
									</div>
                                     <div class="wrapper">
										<span>Confirm Password:</span>
										<asp:TextBox ID="cnfrmpwd" runat="server" TextMode="Password" CssClass="input"></asp:TextBox>							
									</div>
                                    <div class="wrapper">
										<span>Email id:</span>
										<asp:TextBox ID="emailid" runat="server" TextMode="Email" CssClass="input"></asp:TextBox>							
									</div>
                                    <div class="wrapper">
										<span>Phone Number:</span>
										<asp:TextBox ID="phoneno1" runat="server" TextMode="Number" CssClass="input"></asp:TextBox>							
									</div>
									<div class="textarea_box">
										<span>Address:</span>
                                        <asp:TextBox id="address" TextMode="multiline" Columns="300" Rows="5" runat="server" />
																	
									</div>
									<center>
									
                                    <asp:Button ID="SubmitRegForm" runat="server" Text="Send" CssClass="button1" OnClick="SubmitRegForm_Click"></asp:Button>
