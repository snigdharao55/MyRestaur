                                ...
                                <div class="wrap">
						                    <section class="col-1-3"><div class="wrap-col">
							                    <div class="box">
								                    <div class="wrapper">
										<span>User Name:</span>
                                        <asp:TextBox ID="login_uname" runat="server" CssClass="input"></asp:TextBox>
										
									</div>
									<div class="wrapper">
										<span>password:</span>
										<asp:TextBox ID="login_pwd" TextMode="Password" runat="server" CssClass="input"></asp:TextBox>							
									</div>
                                  <center>
                                    <asp:Button ID="SubmitLoginForm" runat="server" Text="Send" CssClass="button1" OnClick="SubmitLoginForm_Click"></asp:Button>	
									</center>
					                    </div>
						                    </div></section>
                                    </div>
                                <img src="images/dr_img.jpg" class="img1"/>
							</form>
